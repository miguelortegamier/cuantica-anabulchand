...
def imprimir_resultado_legible(fila):
    ...
    print(
        f"  Problema: matriz={fila['tamano_matriz']}, filas={fila['num_filas']}, "
        f"columnas={fila['num_columnas']}, variables_qubo={fila['num_variables_qubo']}, "
        f"penalizacion={formatear_numero(fila['penalizacion'])}"
    )
    print(
        f"  Solucion: coste={fila['coste_total']}, optimo={fila['optimo']}, "
        f"ratio={formatear_numero(fila['ratio_optimo'])}, "
        f"brecha={formatear_numero(fila['brecha_optimo'])}, "
        f"desviacion_relativa={formatear_numero(fila['desviacion_relativa_optimo'])}, "
        f"violacion={fila['violacion']}, factible={fila['factible']}, coincide={fila['coincide']}"
    )
    print(
    ...
    print(
        ...
        f"coste_medio_start={formatear_numero(fila['coste_medio_start'])}, "
        f"std_coste_start={formatear_numero(fila['std_coste_start'])}, "
